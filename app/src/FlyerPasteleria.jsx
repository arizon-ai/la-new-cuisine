                    ...
                    <div style={{ marginBottom: '25px' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div>
                                    <EditableText id="flyer-past-duracion-label" defaultValue="Duración del nivel" tag="div" style={{ fontSize: '12px', opacity: 0.9 }} />
                                    <EditableText id="flyer-past-duracion-valor" defaultValue="5 Meses (20 semanas)" tag="div" style={{ fontSize: '18px', fontWeight: 700 }} />
                                </div>
                            </div>
                            ...
                            <div style={{
                                ...
                                <EditableText
                                    id={`flyer-past-${activeLevel}-desc`}
                            ...
                            <div>
                                {getActiveContent().map((item, index) => (
                                    <ContentItem key={index} number={index + 1}>
                                        <EditableText
                                            id={`flyer-past-${activeLevel}-${index}`}
                                            defaultValue={item}
                                            tag="span"
                                        />
                                    </ContentItem>
                    ...
                    {activeLevel === 'avanzado' && (
                        <div style={{
                            ...
                            <ul style={{ margin: 0, paddingLeft: '20px', fontSize: '13px', lineHeight: 1.8 }}>
                                <li><EditableText id="flyer-past-req-1" defaultValue="Aprobación del examen técnico individual" tag="span" /></li>
                                <li><EditableText id="flyer-past-req-2" defaultValue="Presentación del Fine Dining" tag="span" /></li>
                                <li><EditableText id="flyer-past-req-3" defaultValue="Cumplimiento de 240 horas de pasantías" tag="span" /></li>
                                <li><EditableText id="flyer-past-req-4" defaultValue="Entrega del informe final" tag="span" /></li>
                            </ul>
                        </div>
                    )}
